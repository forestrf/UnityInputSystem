...
public class ControlsInput : MonoBehaviour
{
    ...
    void Save()         // Save data
    {
        SaveControls.SaveControlsInput(this);
        Debug.Log("Controls data saved: " + this.m_Action);
        Debug.Log("Controls data saved: " + this.m_Action.ToString());
    }
    ...
    {
        m_RebindOperation.Dispose();
        Debug.Log("ButtonRebindCompleted: " + m_Action);
